...
bool load_content() {
	...
	// Load the cubemap
	array<string, 6> skies = {   "textures/sahara_ft.jpg" /*1*/, "textures/sahara_bk.jpg" /*3*/,"textures/sahara_up.jpg" ,
		"textures/sahara_dn.jpg" , "textures/sahara_rt.jpg" /*2*/,"textures/sahara_lf.jpg"/*4*/};
	// Create cube_map
	cube_map = cubemap(skies);
	// *********************************
	// Load in shaders
	...
	cam.set_target(vec3(0.0f, -20.0f, 0.0f));
