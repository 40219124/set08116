...
bool update(float delta_time) {
	...
	if (glfwGetKey(renderer::get_window(), GLFW_KEY_Q)) {
		target_mesh.get_transform().rotate(eulerAngleY(pi<float>()*delta_time));
	}
	...
	if (glfwGetKey(renderer::get_window(), GLFW_KEY_W)) {
		target_mesh.get_transform().translate(target_mesh.get_transform().orientation * vec3(0.0f, 0.0f, -10.0f * delta_time));
	}
	if (glfwGetKey(renderer::get_window(), GLFW_KEY_S)) {
		target_mesh.get_transform().translate(target_mesh.get_transform().orientation * vec3(0.0f, 0.0f, 10.0f * delta_time));
	}
	if (glfwGetKey(renderer::get_window(), GLFW_KEY_A)) {
		target_mesh.get_transform().translate(target_mesh.get_transform().orientation * vec3(-10.0f * delta_time, 0.0f, 0.0f));
	}
